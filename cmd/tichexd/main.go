...
import (
	...
	"github.com/angelorc/go-tichex/types/util"
	...
	app "github.com/angelorc/go-tichex"
...
var DefaultNodeHome = os.ExpandEnv("$HOME/.tichexd")
...
func main() {
	...
	rootCmd := &cobra.Command{
		Use:               "tichexd",
		Short:             "Tichex App Daemon (server)",
	...
	executor := cli.PrepareBaseCmd(rootCmd, "TH", DefaultNodeHome)
...
func InitCmd(ctx *server.Context, cdc *codec.Codec) *cobra.Command {
	cmd := &cobra.Command{
		...
		RunE: func(_ *cobra.Command, _ []string) error {
			...
			fmt.Printf("Initialized tichexd configuration and bootstrapping files in %s...\n", viper.GetString(cli.HomeFlag))
			return nil
		},
	}
...
$ tichexd add-genesis-account cosmos1tse7r2fadvlrrgau3pa0ss7cqh55wrv6y9alwh 1000teur,1000tkx
`),
