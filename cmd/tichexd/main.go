...
func exportAppStateAndTMValidators(
	...
	if height != -1 {
		gApp := app.NewTichexBlockchain(logger, db, traceStore, false, uint(1))
	...
	gApp := app.NewTichexBlockchain(logger, db, traceStore, true, uint(1))
	return gApp.ExportAppStateAndValidators(forZeroHeight, jailWhiteList)
}
