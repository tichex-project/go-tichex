...
import (
	...
	nsclient "github.com/angelorc/go-tichex/x/nameservice/client"
	nsrest "github.com/angelorc/go-tichex/x/nameservice/client/rest"
)
...
var defaultCLIHome = os.ExpandEnv("$HOME/.tichexcli")
