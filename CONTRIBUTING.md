...
contributors, the general procedure for contributing has been established:
  ...
  1. either [open](https://github.com/tichex-project/go-tichex/issues/new/choose) or
     [find](https://github.com/tichex-project/go-tichex/issues) an issue you'd like to help with,
...
Other notes:
  - Looking for a good place to start contributing? How about checking out some
    [good first issues](https://github.com/tichex-project/go-tichex/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22)
...
`$GOPATH/src/github.com/tichex-project/go-tichex `, and do all the work there.

For instance, to create a fork and work on a branch of it, I would:

  - Create the fork on github, using the fork button.
  - Go to the original repo checked out locally (i.e. `$GOPATH/src/github.com/tichex-project/go-tichex`)
...
### Development Procedure
  ...
  - create a development branch either on github.com/tichex-project/go-tichex, or your fork (using `git remote add origin`)
