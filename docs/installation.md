...
Next, let's install the latest version of Gaia. Make sure you `git checkout` the correct [released version](https://github.com/tichex-project/go-tichex/releases).

```bash
git clone -b <latest-release-tag> https://github.com/tichex-project/go-tichex
