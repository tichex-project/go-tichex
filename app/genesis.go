...
// TichexBlockchainGenState creates the core parameters for genesis initialization for Tichex
// note that the pubkey input is this machines pubkey
func TichexBlockchainGenState(cdc *codec.Codec, genDoc tmtypes.GenesisDoc, appGenTxs []json.RawMessage) (
...
// NewDefaultGenesisState generates the default state for Tichex.
...
// TichexValidateGenesisState ensures that the genesis state obeys the expected invariants
// TODO: No validators are both bonded and jailed (#2088)
// TODO: Error if there is a duplicate validator (#1708)
// TODO: Ensure all state machine parameters are in genesis (#1704)
func TichexValidateGenesisState(genesisState GenesisState) error {
...
// TichexAppGenStateJSON returns genesis state with JSON
func TichexBlockchainGenStateJSON(cdc *codec.Codec, genDoc tmtypes.GenesisDoc, appGenTxs []json.RawMessage) (
	appState json.RawMessage, err error) {
	// create the final app state
	genesisState, err := TichexBlockchainGenState(cdc, genDoc, appGenTxs)
	if err != nil {
		return nil, err
	}
