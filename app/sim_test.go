...
func getSimulateFromSeedInput(tb testing.TB, w io.Writer, app *TichexBlockchain) (
...
func testAndRunTxs(app *TichexBlockchain) []simulation.WeightedOperation {
...
func invariants(app *TichexBlockchain) []sdk.Invariant {
...
func BenchmarkFullAppSimulation(b *testing.B) {
	...
	app := NewTichexBlockchain(logger, db, nil, true, 0)
...
func TestFullAppSimulation(t *testing.T) {
	...
	app := NewTichexBlockchain(logger, db, nil, true, 0, fauxMerkleModeOpt)
	require.Equal(t, "TichexBlockchain", app.Name())
...
func TestAppImportExport(t *testing.T) {
	...
	newApp := NewTichexBlockchain(log.NewNopLogger(), newDB, nil, true, 0, fauxMerkleModeOpt)
	require.Equal(t, "TichexBlockchain", newApp.Name())
