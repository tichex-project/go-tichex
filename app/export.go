...
// ExportAppStateAndValidators exports the state of Tichex for a genesis file
func (app *TichexBlockchain) ExportAppStateAndValidators(forZeroHeight bool, jailWhiteList []string) (
...
func (app *TichexBlockchain) prepForZeroHeightGenesis(ctx sdk.Context, jailWhiteList []string) {
