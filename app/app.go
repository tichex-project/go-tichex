...
// TichexBlockchain contains ABCI application
...
func NewTichexBlockchain(logger log.Logger, db dbm.DB, traceStore io.Writer, loadLatest, assertInvariantsBlockly bool, baseAppOptions ...func(*bam.BaseApp)) *TichexBlockchain {
...
func (app *TichexBlockchain) initFromGenesisState(ctx sdk.Context, genesisState GenesisState) []abci.ValidatorUpdate {
...
func (app *TichexBlockchain) LoadHeight(height int64) error {
