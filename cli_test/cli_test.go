...
func TestTichexCLIKeysAddMultisig(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestTichexCLIKeysAddRecover(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestTichexCLIKeysAddRecoverHDPath(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestTichexCLIMinimumFees(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)

	// start tichexd server with minimum fees
...
func TestTichexCLIGasPrices(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestTichexCLIFeesDeduction(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestTichexCLISend(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)

	// start tichexd server
	proc := f.GDStart()
	defer proc.Stop(false)
...
func TestTichexCLIConfirmTx(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestTichexCLIGasAuto(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestTichexCLICreateValidator(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestTichexCLIQueryRewards(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
	cdc := app.MakeCodec()
	...
	genFile := filepath.Join(f.TichexdHome, "config", "genesis.json")
...
func TestTichexCLISubmitProposal(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestTichexCLISubmitParamChangeProposal(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestTichexCLISubmitCommunityPoolSpendProposal(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestTichexCLIQueryTxPagination(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestTichexCLIValidateSignatures(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestTichexCLISendGenerateSignAndBroadcast(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestTichexCLIMultisignInsufficientCosigners(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestTichexCLIEncode(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestTichexCLIMultisignSortSignatures(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestTichexCLIMultisign(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestTichexCLIConfig(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
	...
	config, err := ioutil.ReadFile(path.Join(f.TichexcliHome, "config", "config.toml"))
	require.NoError(t, err)
...
func TestTichexdCollectGentxs(t *testing.T) {
	t.Parallel()
...
func TestTichexdAddGenesisAccount(t *testing.T) {
	t.Parallel()
	f := NewFixtures(t)
