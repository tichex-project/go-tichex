...
import (
	...
	tapp "github.com/tichex-project/tichex/app"
...
func InitializeLCD(nValidators int, initAddrs []sdk.AccAddress, minting bool, portExt ...string) (
	...
	db := dbm.NewMemDB()
	app := tapp.NewTichexBlockchain(logger, db, nil, true, 0)
	cdc = tapp.MakeCodec()
...
func startTM(
	...
	privVal tmtypes.PrivValidator, app *tapp.TichexBlockchain,
) (*nm.Node, error) {
...
func registerRoutes(rs *lcd.RestServer) {
	...
	tapp.ModuleBasics.RegisterRESTRoutes(rs.CliCtx, rs.Mux)
}
